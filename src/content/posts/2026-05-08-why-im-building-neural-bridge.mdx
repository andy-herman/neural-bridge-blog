...
Different problems, separate repos, no shared memory. Or twenty browser tabs. Or both. The pattern is universal.
...
Worse: my instinct is to spin up another repo every time I want to add a capability. The portfolio grows. The compounding does not.
...
Short posts, no preamble, no marketing language. If something doesn't work, I'll say so.
